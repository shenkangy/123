...
<html lang="en" charset="utf-8">
	<head>
	<title>爱屋及屋 www.aiwujiwu.com</title>
	<meta charset="utf-8">
            ...
            <div class="container">
	            ...
	            <div class="nav-collapse nav-collapse_  collapse">
	                <ul class="nav sf-menu">
	                	...
	                	<li class="sub-menu"><a href="process">房源类型</a>
			                <ul>
			                    <li><a href="#">房源1</a></li>
			                    <li><a href="#">房源1</a></li>
			                    <li><a href="#">房源1</a></li>
...
<div class="bg-content">
	    ...
	    <div class="row">
	        ...
	        <span id="responsiveFlag"></span>
		        <div class="block-slogan">
		            <h2>真正属于我们北漂的房子！</h2>
		            <div>
		            <p>从商业化的模型中走出来，找到属于我们自己的一片天地，爱屋及屋！伴你度过精彩的每一天！</p>
		          	</div>
	            </div>
	      	</div>
	    </div>
	...
	<div class="row-2" style="background:#cccccc">
	    <div class="container">
	       	<h2>共享房屋资源</h2>
		    ...
		    <article class="span6">
		        <h3>关于我们</h3>
		            ...
		            <div class="inner-1 overflow extra">
		                  <div class="txt-1">我们是一个专门为远离家乡来到北京来打工的年轻人提供的一套房屋租赁平台。</div>
		                 我们只是想打造一个这样的平台：为有需要的个人、室内设计师提供一个欣赏别人作品的平台，从中找到自己想要的房屋或者是找到一个自己的温馨小窝。 
		                </div>
		          	</div>
		    </article>
		    <article class="span6">
		        ...
		        <div class="wrapper">
			        ...
			        <ul class="list list-pad">
			            ...
			            <li><a href="" target="_blank">株洲房产网</a></li>
			        </ul>
			        <ul class="list">
